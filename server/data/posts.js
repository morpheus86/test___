export default [
  ...
  },
  {
    ...
    details:
      "Allow video attachments because sometimes a single photo isn't enough to explain the issue.",
  ...
  },
  {
    ...
    details:
      "When realising that their post actually doesn't make much sense, the only option users have to get rid of it is deleting the post. This is not optimal, since then other users might be submitting that again even though it was posted before!\n" +
      "\n" +
  ...
  },
  {
    ...
    details:
      "Would be nice to have instant or hourly email notifications to help us be more responsive with our users.",
  ...
  },
  {
    ...
    details:
      "Teams responding to posts are a great way to show users they're listening. Sometimes posts get lost and end up not being responded to. It would be great to have a section in the dashboard with unanswered posts ranked by number of upvotes.",
  ...
  },
  {
    ...
    details:
      "A native widget would feel a lot better than loading a web view. If we can do this with single sign-on, the experience would be super seamless.\n" +
      "\n" +
  ...
  },
  {
    ...
    details:
      "I can see many features which are worthless to this super product. Please, please do not follow every idea :(\n" +
      "\n" +
  ...
  },
  {
    ...
    details:
      "Expose a single signed on user's notifications via API so they can be integrated into the parent's site.",
  ...
  },
  {
    ...
    details:
      "As a board owner, I want to create  a board that either anonymizes end users such that they are not aware of each other, or allows an end user to anonymize themselves.\n" +
      "\n" +
  ...
  },
  {
    ...
    details:
      "Change users' email/name on their behalf, or use updated email/name from SSO token automatically",
  ...
  },
  {
    ...
    details:
      "I constantly have to switch back to Admin View on my product. If I click the Canny logo to go back to my product's main page, it switches back to Public View. Also, clicking from an email notification switches to Public View. \n" +
      "\n" +
  ...
  },
  {
    ...
    details:
      "Limit the number of votes a user gets (say, 10-15 votes). As features are changed to Complete, give them those votes back to use on other features. I think this would really help surface the top features when people have to be more picky about the things they vote on.",
  ...
  },
  {
    ...
    details:
      "It would be nice to add support for markup so you could create **bold**, *italic* text, headings, * Lists and --- dividers. ✌🏻",
  ...
  },
  {
    ...
    details:
      "Similar to https://feedback.canny.io/feature-requests/p/being-able-to-vote-on-behalf-of-your-users, except for creating posts.",
  ...
  },
  {
    ...
    details:
      "It would be useful for keeping track of overall progress made on posts.",
  ...
  },
  {
    ...
    details:
      "I'd love to be able to close voting/commenting on a post + maybe hide it from users to keep our list of posts cleaner.",
  ...
  },
  {
    ...
    details:
      'Add ability to merge users that were created via the "Add Voter" form in Admin View.',
    title: "Merge Users",
    votes: 14,
  },
  // {
  ...
  //   details:
  //     "We regularly have users replying to Canny's notification emails, which sends the reply email to you. While you guys have been great about forwarding these on, it would be better to either include our email as the Reply-To address in the notification email, or to have the reply added automatically to the post.",
  ...
  //   details:
  //     "A major issue often results in a lot of duplicate posts in a short time. Would be nice to have a banner that we can use to make major announcements / provide updates. Eg 'We are aware of issue X - a fix will be available in Y hours'. Could potentially do this via sticky / pinned posts as well.",
  ...
  //   details:
  //     'Allow outgoing emails to be branded with company email domain vs canny.io.  Have SPF/DKIM settings for deliverability.',
  ...
  //   details:
  //     'Would be great if we could filter notifications by:\n' +
  //     '\n' +
  //     '-Post creations\n' +
  //     '-Mentions\n' +
  //     '-Comments\n' +
  ...
  //   details:
  //     'We currently have 10 boards and each day we delete/merge different posts across these boards. When dug deeper, found that when creating a post, the current board is search and not all of them.',
  ...
  //   details:
  //     "If you've set up feedback.yoursite.com, we should 301 redirect yoursite.canny.io there.",
  ...
  //   details:
  //     'Allow admin to define default visibility (public, unlisted, private) for new posts in a board. Also allow changing post visibility, so you can use it as a moderation feature.',
  ...
  //   details:
  //     'This would be helpful for adding feature releases and batching multiple features together. For example, if a company has multiple products or high-level components that contain a variety features, related or otherwise.',
  ...
  //   details:
  //     "I absolutely love the new Roadmap view, but my one critique is that I feel like it doesn't scale well when you have a lot of items. \n" +
  //     '\n' +
  ...
  //   details:
  //     'Our users keep asking us for the same things over and over. What I usually do, I redirect them to the official Canny thread by sending them links. \n' +
  //     '\n' +
  ...
  //   details:
  //     'Certain customers have mentioned issues with fake accounts / voters.\n' +
  //     '\n' +
  ...
  //   details:
  //     'If a user views feedback.yoursite.com, there should be a link somewhere back to yoursite.com, so they can get back to the main application.',
  ...
  //   details:
  //     "I'd like feature requests/bugs to be flagged that hit a certain threshold of similarity. Our users are doing a very light check for duplicates at best and it'd be great to have some flagged for the admins to resolve.",
  ...
  // details:
  //   'Sometimes I want to attach more than just an image to help my users see the issue. Sometimes a PDF with some larger details would be easier to show. Sometimes a video (see https://feedback.canny.io/feature-requests/p/video-attachments).\n' +
  //   '\n' +
  ...
  // },
  {
    ...
    details:
      "I see there's another post on this for tags. It'd be immensely helpful to have these for Categories given they're externally-facing. If not reordering, some way to sort either alphabetically or by # of posts within.",
  ...
  },
  {
    ...
    details:
      "It would be great to be able to set the order in the roadmap column? \n" +
      "\n" +
  ...
  },
  {
    ...
    details:
      "While scanning Canny, it's hard to tell which posts are linked to Jira and which aren't. It takes too much effort to click into every post to check.\n" +
      "\n" +
      "Showing whether the post is linked in the post list view makes this way easier.",
    title:
      "Show whether a Canny post is linked to a Jira issue from the post list view",
    votes: 12,
  },
  {
    created: "2018-07-17T23:32:37.974Z",
    details:
      "Add a privacy setting so that user comments can only be seen by the team, not other users.",
  ...
  },
  {
    ...
    details:
      "We would rather only use the voting ability and disable the ability for users to submit posts. Posts would be submitted by admins only.",
  ...
  },
  {
    ...
    details:
      "In addition to a title and details field, allow admins to add additional custom fields. In another setting where we use Aha to collect feedback from customer-facing teams, we have custom fields to prompt specific questions like:\n" +
  ...
  },
  {
    ...
    details:
      "Instead of send updates via email, send them through the original conversation on Intercom",
  ...
  //   details:
  //     'Allow customers to give us their Intercom app ID so we can so the messenger on their Canny site.',
  ...
  //   details:
  //     "We'd like to get more options than just changing the tint colour. Something like setting a solid colour across the top of the screen, or changing navigation menu colours, fonts, etc.",
  ...
  //   details:
  //     "It would be great to be able to create your own roadmap view: I'd like to define: \n" +
  ...
  //   details:
  //     'Nice to have - ability to bulk edit posts e.g. change category, tags, statuses, change board etc.',
  //   title: 'Bulk edit',
  //   votes: 29,
  // },
  // {
  ...
  //   details:
  //     "For people who add votes on behalf of their users but didn't initially add their email address. They should be able to add one after the fact.",
  ...
  //   details:
  //     'Have a configuration option to prevent upvotes after a feature has been concluded (closed or completed) or make the completed state more prominent.',
  ...
  //   details:
  //     "I'm currently unable to tell if a bug that was voted for a lot a long time ago is still gaining a lot of votes. It's hard to keep track of what each submission's votes were last time. It would be useful if cards had a way to show me like a line graph of the votes for each day/week on the admin view.",
  ...
  //   details:
  //     'Our users want to filter for ideas they submitted, not just voted on. They take a lot of pride in being the genesis for these ideas. This has a number of votes from our users.',
  ...
  //   details:
  //     "When I receive an email notification about 'Canny' I get confused and think the request is about my product, the emails I get are quite similar.",
  ...
  //   details:
  //     "Sometimes a comment really refers to something separate. It'd be nice if admins could upgrade a comment into a new post.",
  ...
  //   details:
  //     'I would like to have a board template so I can use the same settings for sections like "Create Post Form", "Privacy", and "Tags" for all new boards.',
  ...
  //   details:
  //     "It would be really nice if you could link Feedback Items to a Changelog Entry. Sure, you could find the feedback, copy the URL, and add a link to it in the entry, but I'm looking for something more convenient and two way.\n" +
  //     '\n' +
  ...
  //   details:
  //     "Be able to like a changelog post in the app, and maybe see it's traction on social media, like, tweets, shares, etc.",
  ...
  //   details:
  //     'A lot of data is in Intercom already so we should be able to pull fields from there for segmentation.',
  ...
  //   details:
  //     'Currently it is not possible to create an internal comment via the API, only public comments.',
  ...
  //   details:
  //     'The new UI is causing problems for many tag members. Having all tags displayed helps ensure none are missed.',
  ...
  //   details:
  //     'Boards may be created for different products and it would be helpful to assign boards to a changelog rather than a single log across all boards.',
  ...
  //   details:
  //     'Add a Recently Completed section to the Roadmap view to show posts that were recently marked as completed.',
  ...
  //   details:
  //     'Nice to have, but I like being able to link out to / reference e.g. "Idea-123". Similar to referencing "JIRA-456", it makes communication much easier and clearer.',
  ...
  //   details:
  //     "I'd like the owner field to be able to be seen on the public facing side of our board and not just the admin side! This will help our team as they triage bugs / ideas by communicating to the voters and submitters when something has been taken ownership of.",
  ...
  //   details:
  //     'It will be cool to be able to edit the information of an user already created. Like his email and his name.',
  ...
  //   details:
  //     'My users want to help us out, and suggest some posts to be merged. At our scale, this would be quite tough to manage through comments.',
  ...
  //   details:
  //     'When creating a Post from Slack default the "Customer" field to the Slack user creating the Post.',
  ...
  //   details:
  //     'It would be helpful to be able to preview the rendered Markdown in posts/comments, especially considering the [supported syntax](https://feedback.canny.io/feature-requests/p/markdown-editing-for-posts) is more limited than traditional Markdown. It would help avoid the mistake of using unsupported syntax, like underscores instead of asterisks to italicize text.',
  ...
  //   details:
  //     "I installed the Canny Jira App and as a result it's shown on every Jira project of our organization. Could you do something like the Issue Free Checklist App that you can choose the project on which to activate it? Thanks!",
  ...
  //   details:
  //     'Would be great to give an Admin the option to mark a feature request as "open for early adopters" and give customers/users/people the ability to request inclusion in a Beta / Early Adopter program. This would reduce time spent looking for and recruiting for this stage of the product development lifecycle.',
